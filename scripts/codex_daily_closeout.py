    ...
    *,
    ...
    lines = [
        ...
        *portfolio_value_summary(project_outputs, repo_statuses, gate_results),
        "<!-- llm-summary:end -->",
        "",
        "#### LLM PM Review（推断层，待 Park 确认）",
        "",
        "<!-- llm-pm-review:start -->",
        "- 北极星判断：待 LLM review；基于今日证据判断是否服务于 North Star。",
        "- 昨日 to-do 核对：待 LLM review；只可写“有证据完成 / 部分 / 未找到证据”。",
        "- Gate 解读：待 LLM review；解释未通过和状态未知，不得把无证据项改成通过。",
        "- 明日主攻建议：待 LLM review；从 blocker、gate 和今日成果中选 1 条主攻。",
        "- 内容候选：待 LLM review；判断是否有对外可发布选题，没有就写无。",
        "<!-- llm-pm-review:end -->",
        "",
        "### 1. 北极星对照",
        "",
